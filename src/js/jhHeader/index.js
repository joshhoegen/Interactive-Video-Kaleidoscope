              ...
              <ul data-controller="pagesList" data-show="showMenu" className="pages data-scope">
                <li className="pages-listing data-scope">
                  <a href="http://instagram.com/joshhoegen">
                    ...
                    <span>- Art and life in static images</span>
                  </a>
                </li>
                <li className="pages-listing data-scope">
                ...
                <li className="pages-listing data-scope">
                  <a href="http://linkedin.com/pub/josh-hoegen/b/a9/9b8">
                    <i className="fa fa-linkedin" /> LinkedIn
                    <span>- Professional profile</span>
                  </a>
                </li>
                <li className="pages-listing data-scope">
                  <a href="http://soundcloud.com/byutifu">
                    <i className="fa fa-soundcloud" /> Sound Cloud
                    <span>- Remix of Jazz and other Retro Artists</span>
                  </a>
                </li>
                <li className="pages-listing data-scope">
                  <a href="http://flickr.com/photos/joshhoegen">
